<?php
/* Smarty version 3.1.34-dev-7, created on 2020-02-07 19:15:48
  from '/opt/lampp/htdocs/loja/view/Comprar.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5e3da954b91622_98936825',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3009d4e2961295817b01bb2e200f4204dd873857' => 
    array (
      0 => '/opt/lampp/htdocs/loja/view/Comprar.tpl',
      1 => 1581099346,
      2 => 'file',
    ),
  ),
...
function content_5e3da954b91622_98936825 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
        ...
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Confirmação do Endereço</h4>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="username" 
                        value="<?php  echo $_SESSION['CLI']['cli_nome']?>" autocomplete="off" required>
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control text-center" id="email" value="<?php  echo $_SESSION['CLI']['cli_email']?>" autocomplete="off">
            ...
            <div class="mb-3">
              ...
              value="<?php  echo $_SESSION['CLI']['cli_cidade'].', '. $_SESSION['CLI']['cli_rua'].', '. $_SESSION['CLI']['cli_numero']?>" 
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <select class="custom-select d-block w-100" id="state" >
                  <option value=""><?php echo $_SESSION['CLI']['cli_uf']?></option>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <label for="cc-name">Cliente</label>
                <input type="text" class="form-control backgound"  id="fCliente"  name="fCliente" value="<?php  echo $_SESSION['CLI']['cli_nome']; ?>" readonly="" autocomplete="off">
            </div>  
            <div class="col-md-6 mb-3">
              <label for="cc-name">Valor Da Compra</label>
                <input type="text" class="form-control backgound" name="fValor" value="R$ <?php echo number_format($_smarty_tpl->tpl_vars['TOTAL']->value,1,'.','.');?>
 " readonly="">
            </div>
          </div>
          <div class="row">
